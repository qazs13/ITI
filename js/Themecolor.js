...
document.getElementById('background-color').addEventListener("input",function(event){
    ...
    document.getElementById('main').style.backgroundImage = 'linear-gradient(rgba(0,0,0,0.8),'+Color.backgroundcolor+'),url("/home/awalid/Documents/releases/release2/img/iti.jpg")';
})
